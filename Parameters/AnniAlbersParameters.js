...
function setup() {
    ...
    var width = 800;
    var height = 500;
    var yarn_color = ("#a98585")
    var color_stripes1 = ("#cca3a3");
    var color_stripes2 = ("#866868");
    var color_stripes3 = ("#634b4b");
    ...
    stroke(yarn_color); // cream matches dropper sourced color of inspo
